  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden bg-slate-50">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/80 backdrop-blur-sm border border-cyan-100 text-xs font-bold mb-6 text-brand-cyan">
            <span className="flex h-2 w-2 rounded-full bg-brand-cyan animate-ping" />
                Soroban Mainnet Soon
          </div>
          <h1 className="text-6xl md:text-8xl font-bold leading-[1.1] mb-8 text-slate-900">
            Trade at the <br />
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Link href="#features" className="px-8 py-4 bg-white border border-cyan-100 text-slate-600 rounded-2xl font-bold hover:bg-slate-50 transition-colors">
              Read Docs
            </Link>
          </div>
        ...
        >
          ...
          >
             ...
             <motion.div 
                ...
                className="absolute -top-6 -left-6 bg-white/90 backdrop-blur-md border border-cyan-100 px-6 py-4 rounded-3xl shadow-xl"
             >
                 <div className="flex items-center gap-3">
                    ...
                    <div>
                       ...
                       <div className="text-xl font-bold text-slate-900">248 TPS</div>
                    </div>
                 </div>
             </motion.div>
          </motion.div>
